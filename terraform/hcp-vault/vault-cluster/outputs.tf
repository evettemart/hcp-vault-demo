...
output "cluster_2_id" {
  ...
  description = "Cluster 2 ID (secondary to cluster 1)"
}

output "cluster_3_id" {
  value       = try(module.vault_secondary_to_cluster_1["cluster_3"].cluster_id, null)
  description = "Cluster 3 ID (secondary to cluster 1 in prod; null in non-prod)"
}

output "cluster_4_id" {
  value       = try(module.vault_secondary_to_cluster_1["cluster_4"].cluster_id, null)
  description = "Cluster 4 ID (secondary to cluster 1 in prod; null in non-prod)"
}

output "cluster_5_id" {
  value       = try(module.vault_secondary_to_cluster_1["cluster_5"].cluster_id, null)
  description = "Cluster 5 ID (secondary to cluster 1 in prod; null in non-prod)"
}

output "cluster_6_id" {
  value       = try(module.vault_secondary_to_cluster_1["cluster_6"].cluster_id, null)
  description = "Cluster 6 ID (secondary to cluster 1 in prod; null in non-prod)"
}
...
output "cluster_4_public_endpoint" {
  value       = try(module.vault_secondary_to_cluster_1["cluster_4"].public_endpoint_url, null)
  description = "Cluster 4 public endpoint"
}
...
output "cluster_6_public_endpoint" {
  value       = try(module.vault_secondary_to_cluster_1["cluster_6"].public_endpoint_url, null)
  description = "Cluster 6 public endpoint"
}

output "azure_peering_link_cluster_1" {
  value       = try(module.hvn_azure_connectivity["cluster_1"].peering_self_link, null)
  description = "Azure peering self link for cluster 1"
}

output "azure_peering_link_cluster_2" {
  value       = try(module.hvn_azure_connectivity["cluster_2"].peering_self_link, null)
  description = "Azure peering self link for cluster 2"
}

output "azure_peering_link_cluster_3" {
  value       = try(module.hvn_azure_connectivity["cluster_3"].peering_self_link, null)
  description = "Azure peering self link for cluster 3"
}

output "azure_peering_link_cluster_4" {
  value       = try(module.hvn_azure_connectivity["cluster_4"].peering_self_link, null)
  description = "Azure peering self link for cluster 4"
}

output "azure_peering_link_cluster_5" {
  value       = try(module.hvn_azure_connectivity["cluster_5"].peering_self_link, null)
  description = "Azure peering self link for cluster 5"
}

output "azure_peering_link_cluster_6" {
  value       = try(module.hvn_azure_connectivity["cluster_6"].peering_self_link, null)
  description = "Azure peering self link for cluster 6"
}
